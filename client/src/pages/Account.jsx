        ...
        <section>
          <Row className="m-auto text-center">
            ...
            <Col className="m-auto text-center">
              ...
              <img src={ava02} alt="" className="avatar__list" onClick={()=> {setAvatarUrl(avatar02); addingOverlay.classList.add('animateRemovingOverlay'); document.getElementById('account_avatar').src = avatar01;}} />
              <img src={ava03} alt="" className="avatar__list" onClick={()=> {setAvatarUrl(avatar03); addingOverlay.classList.add('animateRemovingOverlay'); document.getElementById('account_avatar').src = avatar01;}} />
              <img src={ava04} alt="" className="avatar__list" onClick={()=> {setAvatarUrl(avatar04); addingOverlay.classList.add('animateRemovingOverlay'); document.getElementById('account_avatar').src = avatar01;}} />
              <img src={ava05} alt="" className="avatar__list" onClick={()=> {setAvatarUrl(avatar05); addingOverlay.classList.add('animateRemovingOverlay'); document.getElementById('account_avatar').src = avatar01;}} />
              <img src={ava06} alt="" className="avatar__list" onClick={()=> {setAvatarUrl(avatar06); addingOverlay.classList.add('animateRemovingOverlay'); document.getElementById('account_avatar').src = avatar01;}} />
            </Col>
          </Row>
